...
namespace Pulumi.Hetznerdns
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Hetznerdns.version.txt");
    ...
    internal sealed class HetznerdnsResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public HetznerdnsResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
